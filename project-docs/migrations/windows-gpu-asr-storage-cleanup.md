...
.\scripts\cleanup-asr-storage.ps1 `
  -RootPath 'D:\ServiceData' `
  -AuditPath 'D:\ServiceData\cleanup-audit\dryrun.json'
```
...
.\scripts\cleanup-asr-storage.ps1 `
  ...
  -Apply `
  -WhatIf `
  -AuditPath 'D:\ServiceData\cleanup-audit\apply-preview.json'
```
...
.\scripts\cleanup-asr-storage.ps1 `
  ...
  -Apply `
  -Confirm `
  -AuditPath 'D:\ServiceData\cleanup-audit\apply.json'
```
...
Arguments:
  ...
  -RootPath D:\ServiceData
  -AuditPath D:\ServiceData\cleanup-audit\scheduled-dryrun.json
```
...
```powershell
Get-ChildItem 'D:\ServiceData' -Force -Directory
Get-PSDrive D
```
