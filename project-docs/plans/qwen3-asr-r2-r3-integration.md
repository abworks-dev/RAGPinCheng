...
```text
资格根：
D:\Services\RAGPinCheng-ASR\qualification\qwen3-asr

每次 run：
D:\Services\RAGPinCheng-ASR\qualification\qwen3-asr\runs\<github.run_id>\

固定非敏感样本：
D:\ServiceData\RAGPinCheng-ASR\qualification\qwen3-asr\inputs\

ASR 模型最终目录：
D:\ServiceData\RAGPinCheng-ASR\models\Qwen3-ASR-0.6B\
5eb144179a02acc5e5ba31e748d22b0cf3e303b0\

Aligner 最终目录：
D:\ServiceData\RAGPinCheng-ASR\models\Qwen3-ForcedAligner-0.6B\
