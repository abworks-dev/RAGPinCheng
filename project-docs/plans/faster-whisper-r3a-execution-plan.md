...
```text
主机名=FJPCSEVER
ZeroTier IP=10.205.165.105
SSH user=Administrator
生产仓库=D:\RAGPinCheng
预期 HEAD=e2374e37e1357be3d8df93d6d3429bb0947fb9ba
GPU=RTX 5060 Ti 16 GiB
预期 SSH ED25519 fingerprint=SHA256:nRSpKS3UAsE2IecHqyxSryD4Q9Af1piSF4siM+LTS9M
```
...
```text
E:\FunASR-Phase0\faster-whisper-runs\
