...
$AllowedBgeUrls=@('http://127.0.0.1:8100','http://192.168.11.11:8100')
...
if($SelfTest){
  $sample=Resolve-Run 'E:\FunASR-Phase0\faster-whisper-runs\phase0-fw-r3a-retry-20260801-080000'
  $token=Join-Path $sample ('state\bge-token-'+(Split-Path -Leaf $sample)+'.dpapi')
  $result=[ordered]@{passed=($token-eq 'E:\FunASR-Phase0\faster-whisper-runs\phase0-fw-r3a-retry-20260801-080000\state\bge-token-phase0-fw-r3a-retry-20260801-080000.dpapi');token_path=$token}
