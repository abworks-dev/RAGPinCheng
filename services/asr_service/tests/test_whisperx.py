...
import services.asr_service.engines.whisperx as whisperx_engine
...
from services.asr_service.engines.whisperx import WhisperXEngine, _decode_audio_bytes
...
def test_audio_bytes_are_decoded_through_ffmpeg_stdin_without_tempfile(monkeypatch):
    ...
    monkeypatch.setattr("services.asr_service.engines.whisperx.subprocess.run", run)
    monkeypatch.setattr(
        whisperx_engine,
        "importlib",
...
def test_audio_decode_failure_is_sanitized(monkeypatch):
    ...
    monkeypatch.setattr("services.asr_service.engines.whisperx.subprocess.run", fail)
    monkeypatch.setattr(
        whisperx_engine,
        "importlib",
