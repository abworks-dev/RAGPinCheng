...
Run with:
    ...
    pytest services/gpu_service/tests/test_contract.py -v
"""
...
from services.gpu_service.app import app, _activity_tracker, _model_manager
...
def test_dense_dimension_1024():
    ...
    from services.gpu_service.config import EMBED_DIM
...
def test_sparse_indices_values_match():
    ...
    from services.gpu_service.schemas import EmbeddingItem
