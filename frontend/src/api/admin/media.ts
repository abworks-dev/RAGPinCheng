...
export const adminMediaApi = {
  ...
  transcriptSummary: (...args: Parameters<typeof api.transcriptSummary>) => api.transcriptSummary(...args),
  transcriptReviewSuggestions: (...args: Parameters<typeof api.transcriptReviewSuggestions>) => api.transcriptReviewSuggestions(...args),
  bulkTranscriptAiOptimize: (...args: Parameters<typeof api.bulkTranscriptAiOptimize>) => api.bulkTranscriptAiOptimize(...args),
