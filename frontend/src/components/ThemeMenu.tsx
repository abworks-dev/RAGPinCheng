  ...
  return (
    <div ref={ref} className="relative">
      <button
        ...
        className={`flex h-10 items-center rounded-ui-md text-muted-foreground hover:bg-secondary hover:text-foreground ${collapsed ? "w-10 justify-center p-0" : "w-full gap-3 pl-4 pr-2"}`}
      >
