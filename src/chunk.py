        ...
        for parent_text in _split_parents(sec.page_content):
            ...
            parents.append(
                Parent(
                    ...
                    publication_target_id=doc.publication_target_id,
                    sheet_name=located.sheet_name if located else None,
                    cell_range=located.cell_range if located else None,
                    slide_number=located.slide_number if located else None,
                    paragraph_anchor=located.paragraph_anchor if located else None,
