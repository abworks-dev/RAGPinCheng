...
> 状态：**历史 retry 计划；未执行，维护窗口已过期，不得作为当前生产执行入口**
...
- run：`${QUALIFICATION_SANDBOX_ROOT}\faster-whisper-runs\phase0-fw-r3a-20260801-072218`
...
- `${PRODUCTION_REPO_PATH}\data\_transfer_manifest.json`（删除前 25,285 bytes）
- `${PRODUCTION_REPO_PATH}\data\pincheng_docs-8226867163840074-2026-07-26-18-19-11.snapshot`（删除前 262,736,896 bytes）
...
- UTC `2026-07-31` 与 Asia/Shanghai `2026-08-01` 是同一时刻的历史时间口径；本计划的 run identity 和报告均以 Asia/Shanghai `+08:00` 解释。
