...
| 服务目录边界 | 已实现 | `api.main:app` / `asr_service.app:create_app` / `gpu_service.app` | Docker Compose、HTTP 契约、共享转录类型 | [service-directory-boundaries.md](service-directory-boundaries.md) |
