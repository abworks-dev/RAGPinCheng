...
from scripts.legacy_content_migration import file_sha256, load_import_entries, summary


def main() -> int:
    parser = argparse.ArgumentParser(description="Read-only T10 legacy document preflight")
