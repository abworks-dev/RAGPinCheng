...
$InputParent = "${PRODUCTION_DATA_ROOT}\RAGPinCheng-ASR\qualification\qwen3-asr"
...
$manifest = [ordered]@{
    schema_version = "qwen3-asr-qualification-samples/1"
    sample_set_id = "self-made-qwen3-asr-r3"
